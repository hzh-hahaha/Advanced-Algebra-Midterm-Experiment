...
$$
\hat x_\lambda
= \arg\min_x \left(\|Ax-\tilde b\|_2^2+\lambda\|x\|_2^2\right)
$$
...
=
\sum_{i=1}^r
\frac{u_i^T\delta b}{\sigma_i}v_i
$$
...
R
=
\frac{\|A\hat x-\tilde b\|_2}{\|\tilde b\|_2}
$$
...
M
=
\frac{\|\hat x-x\|_2/\|x\|_2}{\|\delta b\|_2/\|b\|_2}
$$
...
B\otimes B
=
(P\otimes P)(\Sigma\otimes\Sigma)(Q\otimes Q)^T
$$
...
$$
\lambda_{\mathrm{oracle}}
=
\arg\min_\lambda
\frac{\|x_\lambda-x\|_2}{\|x\|_2}
$$
